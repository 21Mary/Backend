...
public function getAsInput($value, $isEdit=false){
    return '<p>
        <input type="text" name="prop-'.$this->id.'" value="'.$value.'" class="form-control" placeholder="'.$this->name.' ('.$this->units.')" '.($isEdit ? '' : 'required').'/>
    </p>';
}
