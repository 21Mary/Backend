...
$a = new PurposeList();
$a->getAllFromDatabase('../data/purpose.csv');
$item=null;
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form method="POST">
                        <p>
                            <input type="text" name="name" value="<?php echo $item?$item['name']:'';?>" class="form-control" placeholder="Назва сфери призначення" required/>
                        </p>
                        <p>
