...
const saltsUrl=`http://localhost/lab8/lab8/api/salts.php`;
...
const profileUrl=`http://localhost/lab8/lab8/api/profile.php`;
...
searchForm.addEventListener("submit", function(event) {
        ...
        displaySalts(document.querySelector('#searchForm input[name="search"]').value);
        searchForm.reset();
